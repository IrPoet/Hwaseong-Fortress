gemcutting = {
	...
	amber = function(player)
		...
		elseif skill == "apprentice" then
			...
			elseif (rand > 6 and rand < 30) then
				player:addItem("crafted_amber", 1)
				player:dialogSeq(
					{
						{
			...
			elseif (rand >= 30 and rand < 90) then
				player:addItem("tarnished_amber", 1)
				player:dialogSeq(
					{
						{
		...
		elseif skill == "accomplished" then
			...
			elseif (rand > 7 and rand < 35) then
				player:addItem("crafted_amber", 1)
				player:dialogSeq(
					{
						{
			...
			elseif (rand >= 35 and rand < 90) then
				player:addItem("tarnished_amber", 1)
				player:dialogSeq(
					{
						{
		...
		elseif skill == "adept" then
			...
			elseif (rand > 8 and rand < 40) then
				player:addItem("crafted_amber", 1)
				player:dialogSeq(
					{
						{
		...
		elseif skill == "talented" then
			...
			elseif (rand > 9 and rand < 45) then
				player:addItem("crafted_amber", 1)
				player:dialogSeq(
					{
						{
		...
		elseif skill == "expert" then
			...
			elseif (rand > 11 and rand < 55) then
				player:addItem("crafted_amber", 1)
				player:dialogSeq(
					{
						{
		...
		elseif skill == "master" then
			...
			elseif (rand > 12 and rand < 60) then
				player:addItem("crafted_amber", 1)
				player:dialogSeq(
					{
						{
		...
		elseif skill == "grandmaster" then
			...
			elseif (rand > 13 and rand < 65) then
				player:addItem("crafted_amber", 1)
				player:dialogSeq(
					{
						{
		...
		elseif skill == "legendary" then
			...
			elseif (rand > 20 and rand < 85) then
				player:addItem("crafted_amber", 1)
				player:dialogSeq(
					{
						{
			...
			elseif (rand > 1 and rand < 25) then
				player:addItem("crafted_amber", 1)
				player:dialogSeq(
					{
						{
	...
	whiteamber = function(player)
		...
		elseif skill == "skilled" then
			...
			elseif (rand >= 50 and rand < 90) then
				player:addItem("tarnished_white_amber", 1)
				player:dialogSeq(
					{
						{
